...
export class Constants {
	...
	public static debugDeploymentTemplatePattern =
		"**/deployment.debug.template.json";
	public static tsonPattern = "**/*.template.json";
	public static deploymentJsonPattern =
	...
	public static CHOICE_REPLACE_DECRIPTION =
		"Replace existing Dev Container definitions";
	public static CHOICE_KEEP = "Keep";
	public static CHOICE_KEEP_DECRIPTION =
		"Keep existing Dev Container definitions";
	...
	public static EMPTY_SLN_DESCRIPTION =
		"Create an empty Azure IoT Edge Solution without adding any module";
	public static LANGUAGE_CSHARP_DESCRIPTION =
		"Use Azure IoT C# SDK to build a module";
	public static LANGUAGE_NODE_DESCRIPTION =
		"Use Azure IoT Node.js SDK to build a module";
	public static LANGUAGE_PYTHON_DESCRIPTION =
		"Use Azure IoT Python SDK to build a module";
	public static LANGUAGE_C_DESCRIPTION =
		"Use Azure IoT C SDK to build a module";
	public static LANGUAGE_JAVA_DESCRIPTION =
		"Use Azure IoT Java SDK to build a module";
	public static CSHARP_FUNCTION_DESCRIPTION =
		"Create an Azure Function and deploy to IoT Edge";
	public static MACHINE_LEARNING_DESCRIPTION =
		"Deploy Azure Machine Learning images to Azure IoT Edge";
	public static STREAM_ANALYTICS_DESCRIPTION =
		"Deploy Azure Stream Analytics to Azure IoT Edge";
	public static EVENT_GRID_DESCRIPTION =
		"Deploy Azure Event Grid to Azure IoT Edge";
	public static ACR_MODULE_DESCRIPTION =
		"Import an existing module image from your Azure Container Registry";
	public static EXISTING_MODULE_DESCRIPTION =
		"Import an existing module image from any container registry";
	public static MARKETPLACE_MODULE_DESCRIPTION =
		"Import an existing module image from Azure Marketplace";
	public static EVENT_GRID_IMAGE =
	...
	public static SCAFFOLDING_PREREQUISITES =
		"Please make sure the prerequisites are installed";
	...
	public static edgeRuntimeVersionPrompt =
		"Select Azure IoT Edge Runtime (Edge Hub and Edge Agent images) version";
	...
	public static noSolutionFileWithModulesFolder =
		"No solution file for the selected modules folder can be found in workspace.";
	...
	public static moduleDeploymentManifestJsonPath = [
		"modulesContent",
		"$edgeAgent",
		"properties.desired",
		"modules",
	...
	public static imgDeploymentManifestJsonPath = [
		"modulesContent",
		"$edgeAgent",
		"properties.desired",
		"modules",
	...
	public static routeDeploymentManifestJsonPath = [
		"modulesContent",
		"$edgeHub",
		"properties.desired",
		"routes",
	...
	public static moduleRestartPolicies = [
		"always",
		"never",
		"on-failure",
		"on-unhealthy",
	...
	public static routeSnippetDetail =
		"Route for the Edge Hub. Route name is used as the key for the route. To delete a route, set the route name as null";
	public static platformModuleManifestJsonPath = [
		"image",
		"tag",
		"platforms",
		"*",
	];
	public static setRegistryEnvNotification =
		"Please set container registry credentials to .env file";
	public static acrEnvSet = "ACR credentials have been set in .env file";
	public static envFile = ".env";
	public static inputNamePrompt =
		"Provide the input names of the module to handle message";
	...
	public static platformStatusBarTooltip =
		"Default Platform of IoT Edge Solution";
	public static moduleNameSubstitution = "${moduleName}";
	public static repositoryNameSubstitution = "${repositoryName}";
	public static selectDefaultPlatform =
		"Select Azure IoT Edge Solution Default Platform";
	...
	public static updateSimulatorMsg =
		"Update your 'iotedgehubdev' tool to the latest for the best experience for IoT Edge Simulator.";
	public static failedInstallSimulator =
		"Failed to install 'iotedgehubdev' tool because of error:";
	public static outputNoSimulatorMsg =
		"Cannot execute command since 'iotedgehubdev' is not installed. Please install it first for IoT Edge Simulator.";
	public static outputSimulatorIsInstallingMsg =
		"'iotedgehubdev' is being installed now, and please wait for the installation.";
	public static downloadingAndInstallingStandaloneSimulatorMsg =
		"Downloading and installing Azure IoT EdgeHub Dev Tool (iotedgehubdev) version ";
	public static installStandaloneSimulatorFailedMsg =
		"Failed to install 'iotedgehubdev' tool, please check the output channel (Azure IoT Edge) for detailed error message.";
	public static unexpectedErrorWhenValidateSimulatorUpdate =
		"Unexpected errors occur when install / update 'iotedgehubdev': ";
	public static installManuallyMsg =
		"Please install 'iotedgehubdev' tool first for IoT Edge Simulator.";
	public static queryASAJobInfoFailedMsg =
		"The maximum retry count has been exceeded with empty response from the Stream Analytics.";
	public static needSetupSimulatorMsg =
		"Please setup iotedgehubdev first before starting simulator.";
	public static dockerNotInstalledErrorMsg =
		"Failed to connect to Docker. Is Docker installed?";
	public static dockerNotRunningErrorMsg =
		"Failed to connect to Docker. Is Docker running?";
	public static installDockerUrl = "https://docs.docker.com/install/";
	public static troubleShootingDockerUrl =
		"https://docs.docker.com/config/daemon/";
	public static commandNotFoundErrorMsgPatternOnWindows =
		"not recognized as an internal or external command";
	public static commandNotFoundErrorMsgPatternOnLinux = "command not found";
	public static dockerNotRunningErrorMsgPatternOnWindows =
		"This error may also indicate that the docker daemon is not running";
	public static dockerNotRunningErrorMsgPatternOnLinux =
		"Is the docker daemon running";
	public static permissionDeniedErrorMsgPatternOnLinux = "permission denied";
	public static connectionStringNotSetErrorMsgOnWindows =
		"Cannot find config file. You can press Ctrl + Shift + P to open command palette and run `Azure IoT Edge: Setup IoT Edge Simulator` to setup IoT Edge simulator first.\r\n";
	...
	public static noWorkspaceSetDefaultPlatformMsg =
		"No workspace is opened for setting default platform. Please open a workspace and try again.";
	public static noWorkspaceMsg =
		"This extension only works when folders are opened.";

	public static canOnlyUseWithEdgeSolution =
		"This option is only available when an Azure IoT EdgeSolution is open.";
	public static containerDefinitionIsPresent =
		"This solution currently uses a Dev Container";
