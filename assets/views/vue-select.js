!((t, e) => {
	...
	((t) => {
		...
		(t, e, n) => {
			t.exports = !n(9)(
				() => 7 !== Object.defineProperty({}, "a", { get: () => 7 }).a,
			);
		},
		(t, e) => {
		...
		(t, e, n) => {
			...
			e.f = Object.getOwnPropertyNames || ((t) => o(t, r));
		},
		(t, e) => {
		...
		(t, e, n) => {
			const o = n(31);
			t.exports = Array.isArray || ((t) => "Array" === o(t));
		},
		(t, e, n) => {
			const o = n(35);
			const r = n(14);
		...
		(t, e, n) => {
			...
			const s = n(5).f;
			let a = 0;
			const u = Object.isExtensible || (() => !0);
			const l = !n(9)(() => u(Object.preventExtensions({})));
			const c = (t) => {
				s(t, o, { value: { i: `O${++a}`, w: {} } });
			};
			const f = (t, e) => {
			...
			const d = (t) => (l && h.NEED && u(t) && !i(t, o) && c(t), t);
			const h = (t.exports = {
				KEY: o,
				NEED: !1,
				fastKey: f,
