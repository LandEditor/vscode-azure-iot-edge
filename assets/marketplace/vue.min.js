...
!((e, t) => {
	...
	var o = /-(\w)/g,
		g = e((e) => e.replace(o, (e, t) => (t ? t.toUpperCase() : ""))),
		d = e((e) => e.charAt(0).toUpperCase() + e.slice(1)),
		a = /\B([A-Z])/g,
		_ = e((e) => e.replace(a, "-$1").toLowerCase());
	...
	var An = s("style,class"),
		...
		Nn = (e) => ":" === e.charAt(5) && "xlink" === e.slice(0, 5),
		Ln = (e) => (Nn(e) ? e.slice(6, e.length) : ""),
		In = (e) => null == e || !1 === e;
	function Mn(e) {
		for (var t = e.data, n = e, r = e; D(r.componentInstance); )
			(r = r.componentInstance._vnode) && r.data && (t = Dn(r.data, t));
		while (D((n = n.parent))) n && n.data && (t = Dn(t, n.data));
		return ((e, t) => {
		...
		var n = ((e) => {
			if (
				...
				return -1 < (vr = e.lastIndexOf("."))
					...
					: { exp: e, key: null };
			(pr = e), (vr = hr = mr = 0);
			while (!Nr()) Lr((dr = jr())) ? Mr(dr) : 91 === dr && Ir(dr);
